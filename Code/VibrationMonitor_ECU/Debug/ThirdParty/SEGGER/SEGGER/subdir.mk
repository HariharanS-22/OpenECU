...
ThirdParty/SEGGER/SEGGER/%.o: ../ThirdParty/SEGGER/SEGGER/%.S ThirdParty/SEGGER/SEGGER/subdir.mk
	arm-none-eabi-gcc -mcpu=cortex-m4 -g3 -DDEBUG -c -I"H:/OpenECU/Code/VibrationMonitor_ECU/ThirdParty/SEGGER/SEGGER" -I"H:/OpenECU/Code/VibrationMonitor_ECU/ThirdParty/SEGGER/Config" -I"H:/OpenECU/Code/VibrationMonitor_ECU/ThirdParty/SEGGER/OS" -I"H:/OpenECU/Code/VibrationMonitor_ECU/Module" -x assembler-with-cpp -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" --specs=nano.specs -mfpu=fpv4-sp-d16 -mfloat-abi=hard -mthumb -o "$@" "$<"
